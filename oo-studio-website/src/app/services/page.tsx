        ...
        <div className="px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              <a href="/services" className="px-6 py-2 rounded-full font-bold text-gray-900 bg-gray-900/10">
                Services
              </a>
              <a href="/projects" className="px-6 py-2 rounded-full font-bold text-gray-600 hover:text-gray-900 hover:bg-gray-900/10 transition-all duration-300">
                Projects
              </a>
      ...
      <section className="pt-32 pb-16 px-6 bg-gradient-to-b from-gray-900 to-gray-800">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            お客様のビジネス課題を解決するための幅広いサービスを提供しています。
            <br />
            技術力と創造性を活かし、最適なソリューションをご提案します。
          </p>
        </div>
      </section>
